import {
  U,
  r
} from "./chunk-Z4KY5W2J.js";

// node_modules/@ionic/core/components/p-DWkAgceV.js
...
var r2 = (o, s2, e2, r3, i2, l2, f, p, d) => {
  var $, u;
  const m = s2 ? `calc(100% - ${i2.right + 4}px)` : i2.left - 4 + "px", b = s2 ? "right" : "left", y = s2 ? "left" : "right", X = s2 ? "right" : "left";
  ...
  const w = a(r3).querySelector("ion-icon").getBoundingClientRect(), k = s2 ? w.width / 2 - (w.right - i2.right) + "px" : i2.left - w.width / 2 + "px", T = s2 ? `-${window.innerWidth - i2.right}px` : `${i2.left}px`, A = `${d.top}px`, j = `${i2.top}px`, O = e2 ? [{ offset: 0, transform: `translate3d(${T}, ${j}, 0)` }, { offset: 1, transform: `translate3d(${k}, ${A}, 0)` }] : [{ offset: 0, transform: `translate3d(${k}, ${A}, 0)` }, { offset: 1, transform: `translate3d(${T}, ${j}, 0)` }], B = e2 ? [{ offset: 0, opacity: 1, transform: g }, { offset: 1, opacity: 0, transform: h }] : [{ offset: 0, opacity: 0, transform: h }, { offset: 1, opacity: 1, transform: g }], I = e2 ? [{ offset: 0, opacity: 1, transform: "scale(1)" }, { offset: 0.2, opacity: 0, transform: "scale(0.6)" }, { offset: 1, opacity: 0, transform: "scale(0.6)" }] : [{ offset: 0, opacity: 0, transform: "scale(0.6)" }, { offset: 0.6, opacity: 0, transform: "scale(0.6)" }, { offset: 1, opacity: 1, transform: "scale(1)" }], N = r(), S = r(), Y = r(), z = n("ion-back-button"), C = a(z).querySelector(".button-text"), R = a(z).querySelector("ion-icon");
  z.text = r3.text, z.mode = r3.mode, z.icon = r3.icon, z.color = r3.color, z.disabled = r3.disabled, z.style.setProperty("display", "block"), z.style.setProperty("position", "fixed"), S.addElement(R), N.addElement(C), Y.addElement(z), Y.beforeStyles({ position: "absolute", top: "0px", [X]: "0px" }).beforeAddWrite(() => {
    r3.style.setProperty("display", "none"), z.style.setProperty(b, m);
  }).afterAddWrite(() => {
    r3.style.setProperty("display", ""), z.style.setProperty("display", "none"), z.style.removeProperty(b);
  }).keyframes(O), N.beforeStyles({ "transform-origin": `${b} top` }).keyframes(B), S.beforeStyles({ "transform-origin": `${y} center` }).keyframes(I), o.addAnimation([N, S, Y]);
};
var i = (o, a2, s2, e2, r3, i2, l2, f, p) => {
  var d, $;
  const u = a2 ? "right" : "left", m = a2 ? `calc(100% - ${r3.right}px)` : `${r3.left}px`, b = `${r3.top}px`;
  ...
  const h = l2.top + l2.height / 2 - r3.height * X / 2 + "px", g = s2 ? [{ offset: 0, opacity: 0, transform: `translate3d(${y}, ${h}, 0) ${v}` }, { offset: 0.1, opacity: 0 }, { offset: 1, opacity: 1, transform: `translate3d(0px, ${b}, 0) ${x}` }] : [{ offset: 0, opacity: 0.99, transform: `translate3d(0px, ${b}, 0) ${x}` }, { offset: 0.6, opacity: 0 }, { offset: 1, opacity: 0, transform: `translate3d(${y}, ${h}, 0) ${v}` }], w = n("ion-title"), k = r();
  w.innerText = e2.innerText, w.size = e2.size, w.color = e2.color, k.addElement(w), k.beforeStyles({ "transform-origin": `${u} top`, height: `${r3.height}px`, display: "", position: "relative", [u]: m }).beforeAddWrite(() => {
...
var l = (n2, l2) => {
  ...
  try {
    ...
    if (h || 0 !== w.length || 0 !== g.length ? (T.addElement(h), T.addElement(g)) : T.addElement(X.querySelector(":scope > .ion-page, :scope > ion-nav, :scope > ion-tabs")), k.addAnimation(T), v ? T.beforeClearStyles([p]).fromTo("transform", `translateX(${y})`, `translateX(${$})`).fromTo(p, u, 1) : T.beforeClearStyles([p]).fromTo("transform", `translateX(${b})`, `translateX(${$})`), h) {
    ...
    const A = X.querySelector("ion-header.header-collapse-condense"), { forward: j, backward: O } = ((t, o, n3, l3, c3) => {
      const f2 = e(l3, n3), p2 = s(c3), d2 = s(l3), $2 = e(c3, n3), u2 = null !== f2 && null !== p2 && !n3, m2 = null !== d2 && null !== $2 && n3;
      if (u2) {
    ...
    if (w.forEach((o) => {
      ...
      else if (A || s2.fromTo("transform", `translateX(${b})`, `translateX(${$})`).fromTo(p, 0.01, 1), f2.fromTo("transform", `translateX(${b})`, `translateX(${$})`), d2.beforeClearStyles([p, "transform"]), (null == i2 ? void 0 : i2.translucent) ? d2.fromTo("transform", m ? "translateX(-100%)" : "translateX(100%)", "translateX(0px)") : d2.fromTo(p, 0.01, "var(--opacity)"), j || u2.fromTo(p, 0.01, 1), X2 && !j) {
        const o2 = r();
        o2.addElement(a(X2).querySelector(".button-text")).fromTo("transform", m ? "translateX(-100px)" : "translateX(100px)", "translateX(0px)"), n3.addAnimation(o2);
      }
    }), x) {
      ...
      if (s2 || 0 !== e2.length || 0 !== r3.length ? (n3.addElement(s2), n3.addElement(r3)) : n3.addElement(x.querySelector(":scope > .ion-page, :scope > ion-nav, :scope > ion-tabs")), k.addAnimation(n3), v) {
        n3.beforeClearStyles([p]).fromTo("transform", `translateX(${$})`, m ? "translateX(-100%)" : "translateX(100%)");
        const t = U(x);
        k.afterAddWrite(() => {
      ...
      e2.forEach((o) => {
        ...
        const b2 = r();
        b2.addElement(a(o).querySelector(".toolbar-background"));
        const X2 = r(), x2 = o.querySelector("ion-back-button");
        if (x2 && X2.addElement(x2), n4.addAnimation([s3, e3, f2, X2, b2]), k.addAnimation(n4), X2.fromTo(p, 0.99, 0), e3.fromTo(p, 0.99, 0), f2.fromTo(p, 0.99, 0), v) {
          if (l3 || s3.fromTo("transform", `translateX(${$})`, m ? "translateX(-100%)" : "translateX(100%)").fromTo(p, 0.99, 0), f2.fromTo("transform", `translateX(${$})`, m ? "translateX(-100%)" : "translateX(100%)"), b2.beforeClearStyles([p, "transform"]), (null == i2 ? void 0 : i2.translucent) ? b2.fromTo("transform", "translateX(0px)", m ? "translateX(-100%)" : "translateX(100%)") : b2.fromTo(p, "var(--opacity)", 0), x2 && !O) {
            const o2 = r();
            o2.addElement(a(x2).querySelector(".button-text")).fromTo("transform", `translateX(${$})`, `translateX(${(m ? -124 : 124) + "px"})`), n4.addAnimation(o2);
          }
...
@ionic/core/components/p-DWkAgceV.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
*/
//# sourceMappingURL=chunk-VB3KELGP.js.map
