...
var r = (t3) => {
  let r3, a, s2, d5, l2, f3, c2, v2, m2, u3, p2, y2 = [], g2 = [], A2 = [], b2 = false, C2 = {}, E2 = [], h2 = [], R = {}, S = 0, j2 = false, k2 = false, w2 = true, T = false, D2 = true, F = false;
  ...
  return p2 = { parentAnimation: c2, elements: P3, childAnimations: Y, id: W2, animationFinish: te, from: le, to: (e, o) => {
    ...
    Y.forEach((e) => {
      e.stop();
    }), b2 && (Q(), b2 = false), j2 = false, k2 = false, D2 = true, v2 = void 0, m2 = void 0, u3 = void 0, S = 0, T = false, w2 = true, F = false, M2.forEach((e) => e.c(0, p2)), M2.length = 0;
...
// node_modules/@ionic/core/components/p-A3O24YmY.js
...
var m = (n3, e) => {
  ...
  p(a), L(i2, a, n3.direction), M(e, true), n3.showGoBack ? i2.classList.add("can-go-back") : i2.classList.remove("can-go-back"), E(i2, false), i2.style.setProperty("pointer-events", "none"), a && (E(a, false), a.style.setProperty("pointer-events", "none"));
};
var g = async (n3) => {
  const e = await h(n3);
...
var h = async (n3) => {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (await import("./p-DWkAgceV-QJHOAIZ7.js")).iosTransitionAnimation : (await import("./p-BsBCoGa--JQG3JF2E.js")).mdTransitionAnimation;
};
var y = async (n3, e) => {
  await k(e, true);
  const i2 = n3(e.baseEl, e);
  j(e.enteringEl, e.leavingEl);
  const a = await C(i2, e);
  return e.progressCallback && e.progressCallback(void 0), a && D(e.enteringEl, e.leavingEl), { hasCompleted: a, animation: i2 };
};
var P2 = async (e) => {
  const i2 = e.enteringEl, a = e.leavingEl, o = n.get("focusManagerPriority", false);
  return await k(e, o), j(i2, a), D(i2, a), { hasCompleted: true };
};
var k = async (n3, e) => {
  (void 0 !== n3.deepWait ? n3.deepWait : e) && await Promise.all([B(n3.enteringEl), B(n3.leavingEl)]), await V(n3.viewIsReady, n3.enteringEl);
};
var V = async (n3, e) => {
  n3 && await n3(e);
};
...
@ionic/core/components/p-A3O24YmY.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
*/
//# sourceMappingURL=chunk-Z4KY5W2J.js.map
